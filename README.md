...
- WooCommerce  
- HTML, CSS, Sass  
- Figma (del diseño a la implementación)  
- Git & GitHub  
- Python (en formación)
...
Proyecto real para emprendimiento activo.  
Diseño, maquetación, configuración de tienda y experiencia de usuario.
...
Implementación fiel de un diseño en Figma, enfocada en estructura, espaciados y consistencia visual.

---

🇬🇧 **English**

I am a **WordPress Frontend Developer** with a background in dentistry and a strong focus on user experience and visual implementation.
...
### **Audiophile – WordPress site based on a Figma design**  
👉 https://audiophile.uno  
